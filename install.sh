...
# Create Finder Service (workflow)
echo "Creating Finder Service..."
...
do
	"$HOME/.local/bin/extract-archive/extract.sh" "$f"
				...
				<key>InputUUID</key>
				<string>DB5E0412-080D-4E55-9451-09C20822FC31</string>
				<key>Keywords</key>
				<array>
					<string>Shell</string>
				...
				<key>OutputUUID</key>
				<string>C2AC8122-8C87-43D5-9D29-EC8841620EA9</string>
				<key>UUID</key>
				<string>EB1CC756-7AFE-4043-9988-5E5FB5B1CE0C</string>
				...
				<integer>1</integer>
				<key>location</key>
				<string>485.500000:305.000000</string>
				<key>nibPath</key>
...
echo ""
echo "Next: Right-click any archive file in Finder → Services → 'Extract Archive'."
echo ""
